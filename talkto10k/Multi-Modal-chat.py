...
st.title("Talk to your 10k")

st.header("Application to process companies public 10k documents")

st.markdown(" 10Ks typically contains text, images and tables.\
        User can upload 10K documents - only pdf is supported currently.")

st.text("Please be patient as the time to index the file depends on the size of your file")

st.markdown("Some of the questions to ask:")
st.markdown("I need details for basic and diluted net income per share")
st.markdown("What is deferred income taxes?")
st.markdown("What is cost of revenues, operating expenses and net income")  
